...
import {
  ...
  EventManagerPlugin,
  Title
} from "./chunk-ZRNSOJZV.js";
import {
  HTTP_FETCH_MAX_RESPONSE_SIZE,
  HTTP_ROOT_INTERCEPTOR_FNS
} from "./chunk-XUDSKPWT.js";
import {
  APP_BASE_HREF,
...
var RoutedComponentInputBinder = class _RoutedComponentInputBinder {
  ...
  subscribeToRouteData(outlet) {
    ...
    const dataSubscription = (0, import_rxjs3.combineLatest)([this.options.queryParams ? activatedRoute.queryParams : (0, import_rxjs3.of)({}), activatedRoute.params, activatedRoute.data]).pipe((0, import_operators.switchMap)(([queryParams, params, data], index2) => {
...
This is currently a dev mode only error but will become a call stack size exceeded error in production in a future major version.`);
  ...
  matchSegmentAgainstRoute(injector, rawSegment, route, segments, outlet, parentRoute) {
    return __async(this, null, function* () {
      ...
      const result2 = yield firstValueFrom(matchWithChecks(rawSegment, route, segments, injector, this.urlSerializer, createSnapshot, this.abortSignal));
      if (route.path === "**") {
        rawSegment.children = {};
      }
      if (!result2?.matched) {
...
var RouterConfigLoader = class _RouterConfigLoader {
  ...
  loadChildren(parentInjector, route) {
    ...
    const loader = (() => __async(this, null, function* () {
      try {
        const result2 = yield loadChildren(route, this.compiler, parentInjector, this.onLoadEndListener);
  ...
  handleRouterEvent(e, transition) {
    return __async(this, null, function* () {
      ...
      if (e instanceof NavigationStart) {
        ...
        transition.routesRecognizeHandler.deferredHandle = new Promise((resolve2) => __async(this, null, function* () {
          if (this.urlUpdateStrategy === "eager") {
            try {
              this.maybeCreateNavigationForTransition(transition);
        ...
        transition.beforeActivateHandler.deferredHandle = new Promise((resolve2) => __async(this, null, function* () {
...
//# sourceMappingURL=chunk-OE7TC6HC.js.map
